...
export const LowActivity: Story = {
    args: {
        downloads: generateDownloads(61).map(d => ({ ...d, downloads: Math.random() > 0.8 ? 50 : 0 })),
    },
};

export const HighActivity: Story = {
    args: {
        downloads: generateDownloads(61).map(d => ({ ...d, downloads: Math.floor(Math.random() * 5000) + 2000 })),
    },
};
