...
export function CopyPillButton(props: Props) {
  ...
  return (
    <button
      className={clsx(
        "group border-gray-dim flex cursor-copy items-center gap-4 rounded-full bg-linear-to-tr px-4 py-2 text-sm leading-none transition-all hover:brightness-110",
