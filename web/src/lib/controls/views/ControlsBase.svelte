<script lang="ts">
  ...
  export let variant: 'light' | 'dark' | 'void' | 'black' | undefined = undefined;
...
<aside
  class={clsx(
    `
    fixed top-0 left-0 right-0 h-nav flex px-6 z-10 transition-colors duration-150 ease-in-out
    md:px-12
    lg:px-20
  `,
    {
