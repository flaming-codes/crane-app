    ...
    <>
      ...
      <PageContent>
        ...
        <PageContentSection headline="Team" fragment="team">
          ...
          TypeScript) led us to the discovery of the original CRAN-site. Seeing
          the desperate visual state the site was in, we decided to give it a
          facelift. We&apos;re not affiliated with CRAN or RStudio in any way.
          CRAN/E is the culmination of our efforts to make the site more modern
          and user-friendly and we hope you enjoy it as much as we do! Our main
          focus was ease of use and accessibility, especially for lightning fast
          searches.
        </PageContentSection>
        ...
        <PageContentSection headline="Source Code" fragment="source-code">
          ...
          We&apos;re always happy to hear from you! If you want to support us,
          you can do so by donating to our BuyMeACoffee.
